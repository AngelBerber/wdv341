...
<head>
    ...
    <style>
        *,:after,:before{-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box}
        ...
        p{margin:0 0 2rem}p span{color:#aaa}
...
?>
        ...
        <div class="productBlock">
            <div class="productImage">
                <image <?php echo "src=productImages/". $row['product_image'] ?>>
            </div>
            ...
            <p <?php $counter = $row['product_status'];$counter = count_chars($counter);if ($counter > 0 ) {echo "class='productStatus'";}?>><?php echo $row['product_status']?></p>      
            
            
            <p <?php if ($row['product_inStock'] < 10 ) {echo "class = 'productLowInventory'";}else{echo "class='productInventory'";}    ?>> <?php echo $row['product_inStock']?> in stock!</p>
        </div>
